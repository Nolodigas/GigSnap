...
- **Buscar con IA** — escribe el nombre del evento o pega la URL oficial y GigSnap extrae fecha, lugar, artistas, precio y enlace de entradas
- **Sin clave API** — la búsqueda funciona directamente, sin registro ni configuración
...
- **Ver resumen global** de todos tus gastos con gráfico por categoría y por evento
- **Copia de seguridad** — exporta e importa todos tus datos en JSON desde Ajustes

---

## Cómo funciona la búsqueda

1. Escribe el nombre del evento o pega su URL oficial
2. La app prioriza la web oficial y páginas de entradas
3. Parser híbrido: JSON-LD (schema.org) primero → heurístico completo como fallback
4. Si ya tienes ese evento guardado, lo actualiza en lugar de duplicarlo
